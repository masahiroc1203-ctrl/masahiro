...
#define XY_AFTER_HOMING { 10, 10 } // (mm) Return nozzle near XY origin after G28 (avoids probe-offset confusion)
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 25  // (mm) Ender 3 Pro Bowden: buffer after runout before M600 triggers
 ...
 */
#define RESTORE_LEVELING_AFTER_G28    // Re-enable leveling after G28 homing
...
//#define PREHEAT_BEFORE_LEVELING
  ...
  #define LEVELING_BED_TEMP     50   // (°C) Preheat bed before leveling for thermal accuracy
#endif
